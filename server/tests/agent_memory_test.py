...
from chatbox.chat_agents.graph import AgentState
from chatbox.chat_agents.graph import get_agent_app, initialize_agent, cleanup_agent
...
async def main():
    ...
    async for event in agent_app.astream(inputs_2, config=config):
        pass
